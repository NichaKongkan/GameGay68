...
public class PotionBoard : MonoBehaviour
{
    ...
    private void RemoveAndRefill(List<Potion> _potionsToRemove) {
        //retmoving the potion and clearing the board at that location
    ...
    private void RefillPotion(int x, int y)
    {
        ...
        //we're either hit the top of the board or we found a potion
        if (y + yOffset < height && potionBoard[x,y + yOffset].potion != null) {
            // we're found a potion
        ...
        if (y + yOffset == height) {
            Debug.Log("I've reached the top of the top of the board without finding a potion");
            SpawnPotionAtTop(x);
        }
    }
    ...
    private MatchResult SuperMatch(MatchResult _matchedResults)
    {
        ...
        else if (_matchedResults.direction == MatchDirection.Verical || _matchedResults.direction == MatchDirection.LongVertical) {
            foreach (Potion pot in _matchedResults.connectedPotions) {
                List<Potion> extraConnectedPotions = new();
